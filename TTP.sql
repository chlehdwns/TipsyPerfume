...
CREATE TABLE "TB_PRODUCT" (
	...
	"PDT_STOCK"	NUMBER		DEFAULT 0 NULL,
	...
	"PDT_SHIPPING"	VARCHAR2(1000)		NOT NULL,
...
COMMENT ON COLUMN "TB_PRODUCT"."PDT_SHIPPING" IS '배송비(무료배송/000원) 등 안내';
...
CREATE TABLE "TB_CART" (
	...
	"PDT_NO"	NUMBER		NOT NULL,
	"CART_QUANTITY"	NUMBER	DEFAULT 1	NOT NULL
);
...
CREATE TABLE "TB_PRODUCT_CATEGORY" (
	...
	"PDT_OPTION_DETAIL"	VARCHAR2(100)		NULL
);
...
COMMENT ON COLUMN "TB_PRODUCT_CATEGORY"."PDT_OPTION_DETAIL" IS '브랜드 제품 옵션 (용량 ml / 중량)';
...
COMMENT ON COLUMN "TB_ORDER_PRODUCT"."PDT_NO" IS '상품 번호';
...
ALTER TABLE "TB_ORDER_PRODUCT" ADD CONSTRAINT "FK_PRODUCT_TO_ORDER_PRODUCT" FOREIGN KEY (
	"PDT_NO"
)
REFERENCES "TB_PRODUCT" (
	"PDT_NO"
