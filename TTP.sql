...
COMMENT ON COLUMN "TB_PRODUCT_FILE"."PDT_FILE_LEV" IS '파일레벨 메인 : 1 , 나머지 : 2 이상';
...
ALTER TABLE "TB_REVIEW" ADD CONSTRAINT "FK_ORDER_DETAIL_TO_REVIEW" FOREIGN KEY (
	"ORDER_DETAIL_NO"
)
