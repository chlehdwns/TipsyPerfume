                ...
                <div id="header_1_right_top" class="full_width_divs">
                    ...
                    <div id="header_inner_top_bannerline_2" class="full_height_divs">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <p class="text-center fw-semibold">
                                    <a class="link-offset-2 link-underline link-underline-opacity-0" href="logout.me">로그아웃</a>
                                </p>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    <div id="header_inner_top_bannerline_3" class="full_height_divs">
                        <c:choose>
                            <c:when test="${ empty loginUser }">
                                <p class="text-center fw-semibold">
                                    <a class="link-offset-2 link-underline link-underline-opacity-0" href="insert.me">회원가입</a>
                                </p>
                            </c:when>
                            <c:otherwise>
                                <p class="text-center fw-semibold">
