...
<body>
    ...
    <div id="productMainWrap">
        <div id="productMainTitle">
            ...
            <div class="productMainTitleText">${pdtMainTitleText}</div>
            <div id="productMainTextBottom" class="productMainTitleText">브랜드 | ${pdtCateg}</div>

        </div>
        <div div id="productMainBtnArea">
